...
export default {
    ...
    methods: {
        ...mapActions('ArticlesSingle', ['fetchData', 'updateData', 'resetState', 'setTitle', 'setSummary', 'setContent', 'setPicture', 'setStage', 'setCategory', 'setUser', 'setTags', 'setTitleJP', 'setSummaryJP', 'setContentJP','setSlug']),
        updateTitle(e) {
