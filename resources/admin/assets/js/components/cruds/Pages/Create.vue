                    ...
                    <form @submit.prevent="submitForm" novalidate>
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="title">Name Page JP</label>
                                    <input
                                            type="text"
                                            class="form-control"
                                            name="name_jp"
                                ...
                                <div class="form-group">
                                    <label for="code">Code Page</label>
                                    <input
                                            type="text"
                                            class="form-control"
                                            name="code"
                                ...
                                <div class="form-group">
                                    <label for="content_jp">Content JP</label>
                                    <vue-ckeditor
                                            name="content_jp"
                                            :id="'contentjp'"
...
export default {
    ...
    methods: {
        ...mapActions('PagesSingle', ['storeData', 'resetState', 'setTitle', 'setTitle_jp', 'setDescription', 'setDescription_jp', 'setContent', 'setContent_jp', 'setCode','setName','setName_jp', 'setKeyword','setKeyword_jp','setPicture']),
        updateTitle(e) {
