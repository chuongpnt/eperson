...
export default {
    ...
    methods: {
        ...mapActions('PostsSingle', ['storeData', 'resetState', 'setTitle', 'setSummary', 'setContent', 'setPicture','setRating', 'setViewer', 'setStage', 'setCategory', 'setUser', 'fetchCategoriesAll', 'fetchUsersAll', 'setTitleJP', 'setSummaryJP', 'setContentJP','setIs_Homepage']),
        updateTitle(e) {
