...
export default {
    data() {
        return {
            ...
            xprops: {
                module: 'ContactsUsIndex',
                route: 'contactsus',
                permission_prefix: 'contactsus_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('ContactsUsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ContactsUsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
