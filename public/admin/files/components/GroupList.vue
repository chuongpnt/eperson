<template>
    <div class="component-wrap">
        ...
        <!-- add file group -->
        <v-dialog v-if="dialogs.add.show" fullscreen transition="dialog-bottom-transition" :overlay=false>
            <v-card>
...
<script>
    import FileGroupAdd from './GroupAdd.vue';
    import FileGroupEdit from './GroupEdit.vue';
    export default {
        components: {
            FileGroupAdd,
            FileGroupEdit
        ...
        mounted() {
            console.log('pages.files.components.GroupList.vue');
